...
The last argument is optinal and defines a context for the given triple. This context can be used to define named graphs
...
The <tt>find</tt> method provides an easy way to find specified statements.
  ...
  repository.statements.find :subject => "<a_subject>", :predicate => [ "<a_predicate>", "<another_predicate>" ]
